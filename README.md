# <img width="50px" src="icons/unifebe-logo-vertical.png" alt="Logo hDCHost" class="logo"> ColorSense: Capacitando a Inclusão Visual ![](/icons/html.png)![](icons/arquivo-css.png)![](icons/python.png)
